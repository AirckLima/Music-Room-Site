  ...
  return (
    <main className="grid grid-cols-1 gap-5 min-h-screen mt-[10vh] px-3">
      ...
      <section>
        ...
        <h2 className="text-4xl text-center">So Why Should I Use it?</h2>

        <div className="grid grid-cols-1 lg:grid-cols-3 auto-rows-fr justify-center gap-3 h-fit group">

          <div className="flex flex-col justify-start items-center px-2 py-5 space-y-3  rounded-lg">
